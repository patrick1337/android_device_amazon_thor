...
$(call inherit-product, device/amazon/thor/device-common.mk)

# inherit from the non-open-source side, if present
$(call inherit-product-if-exists, vendor/amazon/thor/device-vendor.mk)

DEVICE_PACKAGE_OVERLAYS := device/amazon/thor/overlay
